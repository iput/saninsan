            ...
            <div class="box-body">
              <table id="exampleb 2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td></td>
                  <td>
                  	<a href="" class="btn btn-xs btn-success"><i class="fa fa-level-down"></i> Lihat Data Kegiatan </a>
                    <a href="" class="btn btn-warning btn-xs btn_edit_personil"><span class="fa fa-pencil"></span> Pengajuan Data Tervalidasi </a>
