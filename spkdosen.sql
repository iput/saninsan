...
--
-- Host: 127.0.0.1
-- Generation Time: 21 Jan 2018 pada 16.09
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
INSERT INTO `penelitian` (`id_penelitian`, `id_dosen`, `unsur`, `sub`, `uraian`, `judul`, `link`, `satuan_hasil`, `jumlah_volume`, `lampiran`, `jumlah_ak`) VALUES
(4, 8, 3, 16, 62, '0', 'www.google.com', 'ijazah', 12, '1-20_en_id1.pdf', 180);
...
--
-- Struktur dari tabel `unsur_kegiatan`
--
...
--
-- Dumping data untuk tabel `unsur_kegiatan`
--
...
--
-- Struktur dari tabel `uraian_kegiatandemo`
--
...
--
-- Dumping data untuk tabel `uraian_kegiatandemo`
--
...
--
-- Ketidakleluasaan untuk tabel `penunjang`
--
ALTER TABLE `penunjang`
